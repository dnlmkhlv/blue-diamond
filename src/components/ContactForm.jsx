      ...
      <div className="bg-gray-100 rounded-lg shadow-md p-8">
        ...
        <form className="space-y-6">
          ...
          <div>
            <button
              type="submit"
              className="w-full bg-primary hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full transition duration-200 ease-in-out" // Updated button color and added transition
            >
              Send Message
            </button>
          </div>
